...
def get_pie_chart (site_dropdown):
    ...
    if site_dropdown == 'ALL':
        ...
        filteredtitle0 = f'Total Successful Launches for site {site_dropdown}'
        fig=px.pie(filtered_df,
                    values='class count',
                    names='class',
                    title=filteredtitle0)
        return fig
...
def scatter (site_dropdown,payload):
    ...
    if site_dropdown == 'ALL':
        ...
        filteredtitle = f'Correlation between Payload and Success for site {site_dropdown}'
